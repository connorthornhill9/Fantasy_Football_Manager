...
- Game locks: once a player's game this week has kicked off, he is frozen for the week, whether he is starting or on the bench. Tables mark these players PLAYED or LIVE next to the opponent. A benched player who already played is NOT a fallback for a later game, and a starter who already played cannot be replaced. Check this before calling anyone a contingency.
- The briefing includes a computed optimal lineup by projection and a heuristic win probability. Treat the optimal lineup as the baseline and adjust for injury news, weather, and matchup context; when you propose a lineup, explain any deviation from the computed optimum. Projection gaps under about 1.5 points are noise: do not swap a starter for that alone; keep the established starter unless injury, role or weather news tips it.
